...
registerOnClick('slab01', false, false, [0,1,2], function() {
  replaceTexture('woodMaterial00', 'wood', 'wood_basecolor_1.jpg', function() {});
}, function() {});

registerOnClick('slab02', false, false, [0,1,2], function() {
  replaceTexture('woodMaterial00', 'wood', 'wood_basecolor_2.jpg', function() {});
}, function() {});

registerOnClick('slab02.001', false, false, [0,1,2], function() {
  replaceTexture('woodMaterial00', 'wood', 'wood_basecolor_3.jpg', function() {});
}, function() {});

status2 = 'closed';

registerOnClick('drawer1', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'drawer1', null, null, 'LoopOnce', 1,
            function() {
      status2 = 'open';
    }, false);
    ...
    operateAnimation('PLAY', 'drawer1', 1, 30, 'LoopOnce', 1,
            function() {
      status2 = 'closed';
    }, true);
...
registerOnClick('drawer2', false, false, [0,1,2], function() {
  if (status2 == 'closed') {

    operateAnimation('PLAY', 'drawer2', null, null, 'LoopOnce', 1,
            function() {
      status2 = 'open';
    }, false);
    ...
    operateAnimation('PLAY', 'drawer2', 1, 30, 'LoopOnce', 1,
            function() {
      status2 = 'closed';
    }, true);
